...
const CarCard = ({
  ...
  return (
    <div className="w-[100%] max-w-[300px] xs:max-w-[310px]  md:max-w-72 lg:max-w-[100%] 3xl:w-[95%] xs:h-[440px] sm:h-[372px] md:h-[350px] lg:h-[390px] xl:h-[510px] 2xl:h-[580px] xxl:h-[540px] 3xl:h-[600px] p-3 xs:p-5 sm:p-2 md:p-2 lg:p-3 xl:p-4 pb-4 flex flex-col items-center rounded-xl bg-[#F3F6F7] justify-between gap-4">
      <div className="lg:h-[40%] xxl:h-[30%] 3xl:h-[40%] rounded-sm w-full">
      ...
      <div className="w-full bg-white h-12 xl:h-16 p-2 xs:p-3 sm:p-2 md:p-1 lg:p-2 xl:p-3 pt-4 pb-4 rounded-md flex flex-row items-center justify-between">
        ...
        <button
          className="bg-primary text-white text-xs xl:text-md md:text-[9px] lg:text-xs rounded-md 3xl:rounded-lg px-2 p-1 xs:px-3 xs:p-2 sm:p-1 pt-2 pb-2 sm:pl-3 sm:pr-3 xl:py-2 xl:px-3 3xl:text-lg"
