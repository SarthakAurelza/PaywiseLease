        ...
        quoteData ? (
          ...
          <>
            <motion.div
              ...
              className="w-full bg-white/50 h-12 xl:h-16 p-2 xs:p-3 sm:p-2 md:p-1 lg:p-2 xl:p-3 pt-4 pb-4 rounded-md flex flex-row items-center justify-between blur-sm border border-gray-200"
            >
