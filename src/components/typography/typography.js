...
export const typography = {
  heading: {
    ...
    h6: "text-sm font-light text-muted-foreground",
  },
  content: {
  ...
  card: {
    carCard: "w-full flex flex-col items-center gap-4 p-4 rounded-xl bg-[#F3F6F7]"
  } 
};
...
export const grids = {
  carFeatureGrid: "w-full grid grid-cols-[2fr_1fr] gap-1"
}
