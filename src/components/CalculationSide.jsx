...
const CalculationSide = ({ car, onClose }) => {
  ...
  return (
    <div className="bg-white flex flex-col lg:p-4 lg:pt-12 lg:pb-12 p-2 sm:p-6 md:p-4 w-full rounded-lg shadow-md lg:gap-4 2xl:gap-8 3xl:gap-16 h-full lg:h-auto justify-between">
      <div className="flex justify-between items-center mb-4">
        <h2 className="font-bold text-xl md:text-2xl lg:text-[30px] 2xl:text-3xl 3xl:text-5xl">Your Calculation</h2>
      ...
      <div className="lg:mb-4 mb-1 xs:mb-2 flex flex-col gap-4">
        <div className='flex flex-row bg-gray-200 items-center justify-start p-1 xs:p-2 md:p-3 gap-3 rounded-lg lg:p-1 lg:pt-2 lg:pb-2 2xl:p-4'>
          ...
          <p className="3xl:text-3xl 2xl:text-xl sm:text-lg xs:text-[16px] text-sm font-semibold text-primary">
            {car.brand.toUpperCase()} {car.model.toUpperCase()} <br /> <span className='font-normal text-xs xs:text-sm lg:text-[13px] xl:text-lg 3xl:text-2xl'>{car.variant.toUpperCase()}</span>
          </p>
        </div>
      ...
      <div className="lg:mb-4 mb-2 flex flex-col md:gap-4 gap-2 lg:gap-4 3xl:gap-8">
        <h3 className="md:text-4xl lg:text-5xl xs:text-3xl text-xl text-[#00445B] font-semibold 2xl:text-6xl 3xl:text-7xl">$500<span className="text-xs xs:text-[16px] text-[#666666] 2xl:text-lg 3xl:text-2xl">/week</span></h3>
      ...
      <button className="bg-[#F0EF4F] text-sm font-semibold sm:text-[18px] w-full py-3 md:py-4 2xl:py-4 3xl:py-6 2xl:text-2xl 3xl:text-4xl rounded">
        Request a Quote
      </button>
    </div>
  );
