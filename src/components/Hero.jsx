...
const Hero = () => {
  ...
  return (
    <div className="bg-primary p-4 sm:p-8 md:pt-10 md:pb-10 lg:pt-14 xl:pt-20 xs:p-8 md:p-5 lg:p-16 text-white flex flex-col sm:gap-6 xl:gap-8 2xl:gap-12 xxl:gap-16 3xl:gap-20">
      {/* Header Section */}
      <div className="flex md:flex-row flex-col items-center sm:items-center md:items-center justify-between md:gap-0 sm:gap-8">
        <div className="flex flex-col gap-4 xs:w-[395px] sm:w-[91%] md:w-[59%] lg:w-[522px] 2xl:w-[660px] xxl:w-[790px] 3xl:w-[1050px] md:items-start items-center">
          <h1 className="lg:text-5xl sm:text-[42px] xs:text-4xl text-2xl font-bold mb-2 md:text-4xl 2xl:text-6xl xxl:text-7xl md:text-start text-center 3xl:text-8xl">Lease your car with us</h1>
          ...
          <a href="#" className="text-secondary sm:text-lg text-[13px] 2xl:text-2xl xxl:text-3xl 3xl:text-4xl underline mb-4 block font-Inter">
      ...
      {/* Dynamic Content */}
      {selectedOption === 'browse' ? (
        <div className="p-4 xs:p-3 sm:p-4 md:py-5 md:p-5 2xl:p-8 xxl:py-10 3xl:py-12 rounded-xl bg-muted">
          <h2 className="sm:text-lg md:text-md lg:text-lg 2xl:text-xl xxl:text-2xl 3xl:text-3xl text-[16px] font-semibold mb-2">Select Preference</h2>
        ...
        <div className="bg-muted p-5 2xl:p-8 xxl:p-12 rounded-md">
          <h2 className="lg:text-lg 2xl:text-xl xxl:text-2xl 3xl:text-3xl sm:font-bold mb-2">Search for Vehicles</h2>
